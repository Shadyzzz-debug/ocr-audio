...
# Implementación de las funciones de texto a voz y limpieza proporcionadas por el usuario
...
st.subheader("Rastreo y Tradición de Runas Prohibidas")
...
st.markdown("---")
st.subheader("Elige la Fuente del Sello")
    ...
    if not text_to_translate.strip():
        ...
        if file_path and os.path.exists(file_path):
            ...
            if display_output_text:
                ...
                st.info(output_text) # Uso st.info para aplicar el estilo gótico de output
